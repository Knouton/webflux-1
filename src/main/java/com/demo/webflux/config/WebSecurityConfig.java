...
import com.demo.webflux.security.AuthenticationManager;
import com.demo.webflux.security.token.BearerTokenServerAuthenticationConverter;
import com.demo.webflux.security.token.JwtHandler;
...
public class WebSecurityConfig {
	...
	private final String [] publicRoutes = {"/api/auth/register", "/api/auth/login", "/actuator/*", "/swagger-ui/*"};
